  ...
  return (
    <section className="ContactMe bg-gradient-to-r from-[#c5c0c1] to-[#8e779a] flex justify-center items-center w-screen h-screen">
      ...
      >
        ...
        <input className="border-2 border-[#630817] font-bold rounded-3xl bg-[#f25454] text-[#630817] px-8 py-2 my-5 hover:cursor-pointer" type="button" value="Button" onClick={onSubmit} />
      </motion.form>
    </section>
  );
};
